...
neighbors=(west east north south above below)
sign=("-" "+" "-" "+" "+" "-")
multiplier=("" "" " * BLOCK_X" " * BLOCK_X" " * BLOCK_X * BLOCK_Y" " * BLOCK_X * BLOCK_Y")
left_hand=(real_x real_x gy gy comp_offset_z comp_offset_z)
right_hand=(" " " (nx - 1) - " " " " (ny - 1) - " " (nz - 1) - " " ")
